...
import { deleteCategoryApi, getCategoryByConditionApi, getCategoryDetailApi, getCurrentCategory, updateCategoryNameApi, updateCategoryThumbnailApi } from '../../redux/reducers/category/categorySlice';
import { useSelector } from 'react-redux';
import { defaultCategoryDetail, defaultCategoryGet } from '../../utils/config';
import { CategoryDetailModel } from '../../_core/CategoryModel';
...
const AdminCategory = () => {
    ...
    return (
        <div>
            ...
            <Table className='border-2 border-blue-300' rowKey={'id'} columns={columns} dataSource={lstCategory} bordered={true} />
        </div>
    )
}
